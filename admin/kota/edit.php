...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['submit_data'])) {
        $kotaController->update_kota($_GET['id'], $_REQUEST);
    }
} else {
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?= $data['nama_kota']; ?>" name="nama" class="form-control">
                                        ...
                                        <div class="form-group">
                                            <label>No Telp</label>
                                            <input type="text" value="<?= $data['ongkos_kirim']; ?>" name="ongkos_kirim" class="form-control">
