...
// check if id is set
if (isset($_GET['id'])) {
    require_once '../controllers/TransaksiControoler.php';
    $produkController = new TransaksiController();
    $data = $produkController->get_order_by_id($_GET['id']);

    if (isset($_POST['submit_data'])) {
        // $produkController->update_produk($_GET['id'], $_REQUEST);
    }
} else {
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="deskripsi" class="form-control" rows="10" style="height: 100px;">
