                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body row detail-product-card pb-2">
                                ...
                                <hr>
                                <h3 class="payment-status-title">Status Pembayaran</h3>
                                <h3 class="payment-status">Belum di verifikasi</h3>
                                <button class="btn btn-primary w-100 mb-3">Kembali ke beranda</button>
                            </div>
                        </div>
                    </div>
                </div>
